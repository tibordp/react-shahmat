...
export const DESCRIPTION = 'Only the correct move is allowed. Shows how to override validMoves to restrict interaction — useful for puzzle trainers and tutorials.';
...
export default function PuzzleBoard() {
  ...
  const handleMove = React.useCallback((move: BoardMove) => {
    game.makeMove(move);
    setSolved(true);
  }, [game]);
  ...
  return (
    <div>
      ...
      />
      {solved && <p style={{ color: '#4caf50', textAlign: 'center', marginTop: 8 }}>Correct! Qxf7#</p>}
      {!solved && <p style={{ color: '#aaa', textAlign: 'center', marginTop: 8 }}>White to play — mate in 1</p>}
    </div>
  );
}

...
export const DESCRIPTION = 'A non-interactive board displaying a position from a FEN string. Set both whiteMovable and blackMovable to false to prevent any interaction.';
